...
dojo.ready(function(){
	...
	learn = {
		...
		getAnswers: function(type){
			...
			dojo.io.script.get({
				url: "http://query.yahooapis.com/v1/public/yql?q=use%20%22http%3A%2F%2Flearnjs.org%2Fyql%2Fvideos.xml%3F1es%22%20as%20videos%3B%20select%20*%20from%20videos%20limit%20"+learn.config.limit+"%20offset%20"+learn.config.offset+"&format=json&_maxage=3600&_rnd=20100802",
				jsonp: "callback",
				load: function(data){
